 ...
 */
class ProductPopUpLazyBuilders implements TrustedCallbackInterface {
   ...
   */
  public function addToCartPopUpForm($product_id, $view_mode, $combine, $langcode) {
